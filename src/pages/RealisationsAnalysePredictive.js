...
const RealisationsAnalysePredictive = () => (
  <div className="min-h-screen bg-gray-100 flex flex-col">
    ...
    <section className="container mx-auto py-24 text-center">
      <h1 className="text-4xl font-bold text-gray-800 mb-4">Réalisations - Analyse Prédictive</h1>
      <p className="text-xl text-gray-600">Contenu bientôt disponible...</p>
    </section>
...
export default RealisationsAnalysePredictive;
